  ...
  head: () => ({
    meta: [
      ...
      { title: "Nova — your personal AI assistant" },
      {
        name: "description",
        content:
          "Nova is a fast, themeable AI assistant with saved conversations and a personal account.",
      },
      { property: "og:title", content: "Nova — your personal AI assistant" },
      {
        property: "og:description",
        content: "Chat with Nova, save your conversations, and pick a theme that fits you.",
      },
